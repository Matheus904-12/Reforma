...
function initMultiStepForm() {
    ...
    document.addEventListener("DOMContentLoaded", function() {
        // Seleciona todos os elementos dentro da classe 'relativi'
        const elements = document.querySelectorAll(".relativi *");
        ...
        elements.forEach((el, index) => {
            gsap.from(el, {
                ...
                delay: index * 0.1,         // Adiciona um pequeno atraso baseado no índice do elemento
